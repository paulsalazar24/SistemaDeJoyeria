...
public class nuevoUsuario extends javax.swing.JFrame {
    ...
    public nuevoUsuario() {
        ...
        txt_password_ver.setVisible(false);
    ...
    private void initComponents() {
        ...
        txt_password_ver = new javax.swing.JTextField();
        ...
        getContentPane().add(jCheckBox_verClave, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 140, -1, 20));

        txt_password_ver.setBackground(new java.awt.Color(255, 255, 255));
        txt_password_ver.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txt_password_ver, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 139, 170, -1));

        txt_password.setBackground(new java.awt.Color(255, 255, 255));
        txt_password.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txt_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 139, 170, -1));
    ...
    private void jButton_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarActionPerformed
        if (txt_nombre.getText().isEmpty() || txt_apellido.getText().isEmpty() || txt_usuario.getText().isEmpty() || txt_password.getText().isEmpty() || txt_telefono.getText().isEmpty()) {
            ...
            //validar si el usurio ya est registrado
    ...
    private void jCheckBox_verClaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jCheckBox_verClaveMouseClicked
        ...
        if (jCheckBox_verClave.isSelected() == true) {
            ...
            txt_password_ver.setText(pass);
            txt_password.setVisible(false);
            txt_password_ver.setVisible(true);
        } else {
            String passwordIngresado = txt_password_ver.getText().trim();
    ...
    private javax.swing.JTextField txt_password_ver;
